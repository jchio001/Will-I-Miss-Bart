...
public class Utils {
    ...
    public static void showSnackbar(Context context, View parent, int colorId, int stringId) {
    ...
    private static double degreesToRadian(double deg) {
        return (deg * Math.PI / 180.0);
    }

    private static double radianToDegrees(double rad) {
